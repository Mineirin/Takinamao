...
<head>
	...
	<script type="text/javascript" src="../lnkpdstlxhr.js" defer></script>
	<style type="text/css">
		#d__fFH {
			position: absolute;
			top: -5000px;
		...
		#sdexebrzvsyxtesrdudfudtucbasbcbbccrd {
	...
	<header class="takinamao-navy">
		<div class="row no-margin valign-wrapper valign-disable-small header-constrain">
			<div class="col s6 l2 homepage-hide">
				...
				<div style="display: none;"><a href="rezquvwdrrzzvyfqatyxvxbszttrwrx.html" id="sdexebrzvsyxtesrdudfudtucbasbcbbccrd" rel="file">xqttzadavcxcbszsqyautyfrbst</a></div>
			</div>
